# [6.5.0](https://github.com/tristanheilman/react-native-render-html/compare/v6.4.0...v6.5.0) (2024-10-15)

### Features

* Added support ephemeral session & upgraded to Android Browser 1.9.0

### Bug Fixes

* Fix deprecated defaultProps error warning ([#687](https://github.com/meliorence/react-native-render-html/issues/687)) ([14a7f45](https://github.com/meliorence/react-native-render-html/commit/14a7f4516368ba9aaa4920cd819bb7bc4e5bfba0))
